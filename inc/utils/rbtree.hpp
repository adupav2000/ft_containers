...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/12 17:01:04 by adu-pavi          #+#    #+#             */
/*   Updated: 2022/05/12 20:55:00 by adu-pavi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	class rbtree
	{
		...
		private:
			...
			node_ptr _getMin(node_ptr root) const
			{
			...
			node_ptr _getMax(node_ptr root) const
			{
			...
			node_ptr _get(value_type const &val) const
			{
				node_ptr tmp = _root;
				while (tmp != _NIL)
				{
